...
<div class="topnav" id="myTopnav">
    ...
    <a class="active" href="reset-password.php">Passwort ändern</a>
    <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
</div>

    <div class="content">
        <div class="mainDivs"><h2>Passwort ändern</h2>
            <p>Fülle dieses Formular aus um dein Passwort zu ändern.</p>
            <form id="defaultForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                    <label>Bestätige dein neues Passwort</label>
